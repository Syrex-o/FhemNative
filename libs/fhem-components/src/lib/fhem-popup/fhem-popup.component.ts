...
import { ComponentLoaderModule, EditButtonComponent, IconModule, PopupComponent } from '@fhem-native/components';
...
@Component({
	standalone: true,
	selector: 'fhem-native-component-popup',
...
export class FhemPopupComponent{
    ...
    setFhemDevice(device: FhemDevice): void{
		...
		if(this.openOnReading) this.popupState = this.buttonState;
    }
