...
export class ResizerDirective{
	...
	private elemPos: { element: HTMLElement, position: ElementPosition } = {
		element: null,
	...
	// move event
	private move(e, className: string): void{
		...
		const l: number = this.structure.roundToGrid(this.resizeMatrix.c * q_x + this.resizeMatrix.a * p_x);
		const t: number = this.structure.roundToGrid(this.resizeMatrix.d * q_y + this.resizeMatrix.b * p_y);
