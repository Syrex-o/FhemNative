import { Component, NgModule, Input, OnInit, OnChanges, SimpleChanges, OnDestroy } from '@angular/core';
...
// Components
import { TransformationsModule } from '../../directives/transformations/transformations.module';
...
export class FhemComponentContainerComponent implements OnInit, OnChanges, OnDestroy{
	...
	@Input() position:any;
	// minimal properties
	@Input() minimumWidth: number = 100;
	@Input() minimumHeight: number = 50;
...
@NgModule({
	...
	declarations: [FhemComponentContainerComponent],
	exports: [FhemComponentContainerComponent]
})
export class FhemContainerModule {}